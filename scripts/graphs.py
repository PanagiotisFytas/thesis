...
def plot(test, N, B):
    ...
    f.legend([line1,line2,line3,line4], ['Source-DPOR', 'Optimal-DPOR'], loc = 'center right', borderaxespad=1 )
...
def stackplots(name):
    ...
    fig.legend([l1,l2,l3,l4,l5,l6], ['Budget Exceeded', 'Disputed Entry Found', 'Finished'], loc = 'center right', borderaxespad=1 )
    # ax1.legend(loc='upper left')
